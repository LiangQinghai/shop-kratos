...
type UserClient interface {
	...
	RegisterUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReply, error)
}
...
func (c *userClient) RegisterUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReply, error) {
...
func (UnimplementedUserServer) RegisterUser(context.Context, *RegisterRequest) (*RegisterReply, error) {
